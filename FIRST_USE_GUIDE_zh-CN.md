...
1. 推荐直接下载最新稳定版：
   <https://github.com/auto-sun/labelImg2-custom/archive/refs/tags/v2.0.1.zip>
...
`v2.0.1` 包含本地模型自动标注，因此会同时安装 Ultralytics 和 PyTorch，
下载体积和安装时间会比旧版本更大。只进行手工标注时仍可正常使用全部原有功能。

`v2.0.1` 整体使用 GNU AGPL v3.0 免费开源；上游 LabelImg2 的 MIT 许可证单独保留在
